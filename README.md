...
schema package plugin for sintering
...
```sh
git clone https://github.com/elenamolteni/sintering.git
cd sintering
...
| Name | E-mail     |
|------|------------|
| Elena Molteni | [elena.molteni@unimi.it](mailto:elena.molteni@unimi.it)
